...
storetest = True
storename = 'SQLAlchemy' # SQLAlchemy declarative Base with AbstractSQLStore

plugin.register(storename, store.Store,
                'rdfextras.store.SQLAdBaseASS', 
                'SQLAlchemyStore')
...
# SQLite file
class SQLAlchemySQLitFileeGraphTestCase(test_graph.GraphTestCase):
    store_name = storename
    path = sqlitefile
