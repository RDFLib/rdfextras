...
class TestLimit(unittest.TestCase):
    ...
    def testLimit(self):
        ...
        results = graph.query(test_query,processor='sparql2sql',DEBUG=True)
        print len(results)
    ...
    def testLimit2(self):
           ...
           results = list(graph.query(test_query2,processor='sparql2sql',DEBUG=True))
           print graph.query(test_query2,processor='sparql2sql').serialize(format='xml')
