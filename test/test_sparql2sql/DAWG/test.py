...
def generictest(testFile):
    func_name = __name__ = __doc__ = id = 'test_sparql2sql.' + \
    ...
    manifestData = manifestG.query(
                      ...
                      parsedQuery=PARSED_MANIFEST_QUERY,
